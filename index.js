...
console.log(Object.keys(appleIndex()));
...
// let carType = inventory.car_make, inventory.car_model;

// function getCarInfoByIndex(inventory, getCar) {
// const getCar = inventory.car_make;
...
function getLastCarInfo() {
  function getCarInfoByIndex(module) {
    for (i = 0; i < module.length - 1; i++)
      return `This is a ${car_make} ${car_model}.`;
  }
}
